# -*- coding: utf-8 -*-
"""
Created on Sun Dec 24 21:32:08 2017
...
# plot hetero_model_homo_data.png
fig = scatter_contour(Y,model,G,True)
fig.savefig("hetero_model_homo_data.png",dpi=120)
# plot hetero_model_homo_data_mixcontour.png
fig = scatter_contour(Y,model,G,False)
fig.savefig("hetero_model_homo_data_mixcontour.png",dpi=120)

# train model
model = GMM(Y,G,False,1e-3)
# plot homo_model_homo_data.png
fig = scatter_contour(Y,model,G,True)
fig.savefig("homo_model_homo_data.png",dpi=120)
# plot homo_model_homo_data_mixcontour.png
fig = scatter_contour(Y,model,G,False)
fig.savefig("homo_model_homo_data_mixcontour.png",dpi=120)